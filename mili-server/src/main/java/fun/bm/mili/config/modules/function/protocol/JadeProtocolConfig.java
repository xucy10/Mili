...
public class JadeProtocolConfig implements ConfigModule {
    @ConfigInfo(name = "enabled", comments = "Enable Jade protocol support") public static boolean enabled = false;
