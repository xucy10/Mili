...
public class BBORProtocolConfig implements ConfigModule {
    @ConfigInfo(name = "enabled", comments = "Enable BBOR protocol support") public static boolean enabled = false;
