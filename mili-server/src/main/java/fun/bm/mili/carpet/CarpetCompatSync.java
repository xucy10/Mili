...
public final class CarpetCompatSync {
    ...
    private static void registerProtocolRules() {
        ...
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "commandBot", FakePlayerCompatConfig.commandBot));
        ...
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "fakePlayerResident", FakePlayerCompatConfig.fakePlayerResident));
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "openFakePlayerInventory", FakePlayerCompatConfig.openFakePlayerInventory));
        ...
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "fakePlayerAutoReplaceTool", FakePlayerCompatConfig.fakePlayerAutoReplaceTool));
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "fakePlayerAutoReplenishment", FakePlayerCompatConfig.fakePlayerAutoReplenishment));
        ...
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "fakePlayerAutoFish", FakePlayerCompatConfig.fakePlayerAutoFish));
        CarpetServerProtocol.CarpetRules.register(CarpetServerProtocol.CarpetRule.of("mili", "fakePlayerReloadAction", FakePlayerCompatConfig.fakePlayerReloadAction));
