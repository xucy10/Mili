...
import fun.bm.mili.config.modules.function.protocol.BladerenProtocolConfig;
...
public class MsptSyncProtocol implements LeavesProtocol {
    ...
    private static final List<ServerPlayer> players = new CopyOnWriteArrayList<>();
    ...
    public int tickerInterval(String tickerID) {
        return BladerenProtocolConfig.msptSyncTickInterval;
    }

    @Override
    public boolean isActive() {
        return BladerenProtocolConfig.msptSyncProtocol;
    }
}
