...
import fun.bm.mili.config.modules.misc.LeavesPacketEventConfig;
...
public class InternalBytebufHandler {
    ...
    private static class PacketHandler extends ChannelDuplexHandler {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            if (!LeavesPacketEventConfig.enabled || msg instanceof BundlePacket<?> || msg instanceof BundleDelimiterPacket<?>) {
