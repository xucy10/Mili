...
public interface RandomSource {
    ...
    // Mili start - flattenTriangularDistribution
    default double triangle(double center, double maxDeviation) {
        if (fun.bm.mili.config.modules.function.OldFeatureConfig.flattenTriangularDistribution) {
            this.nextDouble();
    ...
    // Mili end - flattenTriangularDistribution
