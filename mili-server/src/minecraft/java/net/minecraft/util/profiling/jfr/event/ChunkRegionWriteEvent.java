...
public class ChunkRegionWriteEvent extends ChunkRegionIoEvent {
    ...
    public ChunkRegionWriteEvent(RegionStorageInfo regionStorageInfo, ChunkPos chunkPos, RegionFileVersion version, int bytes) {
        super(regionStorageInfo, chunkPos, version, bytes);
    }
}
