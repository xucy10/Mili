...
public class PacketReceivedEvent extends PacketEvent {
    ...
    public PacketReceivedEvent(String protocolId, String packetDirection, String packetId, SocketAddress address, int bytes) {
        super(protocolId, packetDirection, packetId, address, bytes);
    }
}
