...
public class SoundEvents {
    ...
    private static Holder<SoundEvent> register(Identifier name, Identifier location, float range) {
    ...
    private static Holder.Reference<SoundEvent> registerForHolder(String name) {
        return registerForHolder(Identifier.withDefaultNamespace(name));
    }

    private static Holder.Reference<SoundEvent> registerForHolder(Identifier name) {
    ...
    private static Holder.Reference<SoundEvent> registerForHolder(Identifier name, Identifier location) {
    ...
    private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
        return IntStream.range(0, 8).mapToObj(index -> registerForHolder("item.goat_horn.sound." + index)).collect(ImmutableList.toImmutableList());
    }
        ...
        return Stream.of(WolfSoundVariants.SoundSet.values())
            .collect(
                Collectors.toMap(
                    ...
                    soundSet -> {
                        String soundEventSuffix = soundSet.getSoundEventSuffix();
                        return new WolfSoundVariant(
                            registerForHolder("entity.wolf" + soundEventSuffix + ".ambient"),
                            registerForHolder("entity.wolf" + soundEventSuffix + ".death"),
                            registerForHolder("entity.wolf" + soundEventSuffix + ".growl"),
                            registerForHolder("entity.wolf" + soundEventSuffix + ".hurt"),
                            registerForHolder("entity.wolf" + soundEventSuffix + ".pant"),
                            registerForHolder("entity.wolf" + soundEventSuffix + ".whine")
                        );
                    }
                )
            );
