                                ...
                                .when(
                                    LootItemEntityPropertyCondition.hasProperties(
                                        ...
                                        EntityPredicate.Builder.entity()
                                            .vehicle(EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of(holderGetter, EntityType.CAMEL_HUSK)))
                                            .build()
                                    )
                                )
                        )
        ...
        LootData.WOOL_ITEM_BY_DYE
            .forEach(
                (dyeColor, itemLike) -> this.add(
                    EntityType.SHEEP,
                    BuiltInLootTables.SHEEP_BY_DYE.get(dyeColor),
                            ...
                            LootItem.lootTableItem(Items.RED_MUSHROOM)
                                ...
                                .when(
                                    LootItemEntityPropertyCondition.hasProperties(
                                        LootContext.EntityTarget.THIS,
                                        EntityPredicate.Builder.entity()
                                            .vehicle(EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of(holderGetter, EntityType.ZOMBIE_HORSE)))
                                            .build()
                                    )
                                )
                        )
