...
public class BiomeDefaultFeatures {
    ...
    public static void addDefaultOres(BiomeGenerationSettings.Builder builder, boolean largeOres) {
        ...
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, largeOres ? OrePlacements.ORE_COPPER_LARGE : OrePlacements.ORE_COPPER);
    ...
    public static void addDefaultExtraVegetation(BiomeGenerationSettings.Builder builder, boolean isSurface) {
    ...
    public static void swampSpawns(MobSpawnSettings.Builder builder, int skeletonWeight) {
    ...
    public static void oceanSpawns(MobSpawnSettings.Builder builder, int squidWeight, int squidMaxCount, int codWeight) {
        builder.addSpawn(MobCategory.WATER_CREATURE, squidWeight, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 1, squidMaxCount));
    ...
    public static void warmOceanSpawns(MobSpawnSettings.Builder builder, int squidWeight, int squidMinCount) {
        builder.addSpawn(MobCategory.WATER_CREATURE, squidWeight, new MobSpawnSettings.SpawnerData(EntityType.SQUID, squidMinCount, 4));
    ...
    public static void snowySpawns(MobSpawnSettings.Builder builder, boolean isPlateau) {
        ...
        caveSpawns(builder);
        monsters(builder, isPlateau ? 90 : 95, 5, isPlateau ? 5 : 0, 20, false);
    ...
    public static void monsters(
        MobSpawnSettings.Builder builder, int zombieWeight, int zombieVillagerWeight, int zombieHorseWeight, int skeletonWeight, boolean isUnderwater
    ) {
        builder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));
        builder.addSpawn(MobCategory.MONSTER, zombieWeight, new MobSpawnSettings.SpawnerData(isUnderwater ? EntityType.DROWNED : EntityType.ZOMBIE, 4, 4));
