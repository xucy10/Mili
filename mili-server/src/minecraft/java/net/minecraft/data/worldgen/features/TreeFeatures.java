...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        FeatureUtils.register(
            context, OAK_LEAF_LITTER, Feature.TREE, createOak().decorators(ImmutableList.of(placeOnGroundDecorator, placeOnGroundDecorator1)).build()
        );
        FeatureUtils.register(
            context,
        ...
        FeatureUtils.register(
            context, BIRCH_LEAF_LITTER, Feature.TREE, createBirch().decorators(ImmutableList.of(placeOnGroundDecorator, placeOnGroundDecorator1)).build()
        );
        FeatureUtils.register(
            context, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(placeOnGroundDecorator, placeOnGroundDecorator1)).build()
        );
