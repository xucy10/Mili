...
public class AncientCityStructurePieces {
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> context) {
        ...
        Holder<StructureProcessorList> orThrow = holderGetter.getOrThrow(ProcessorLists.ANCIENT_CITY_START_DEGRADATION);
        ...
        context.register(
            ...
            new StructureTemplatePool(
                orThrow1,
                ImmutableList.of(
                    Pair.of(StructurePoolElement.single("ancient_city/city_center/city_center_1", orThrow), 1),
                    Pair.of(StructurePoolElement.single("ancient_city/city_center/city_center_2", orThrow), 1),
                    Pair.of(StructurePoolElement.single("ancient_city/city_center/city_center_3", orThrow), 1)
                ),
