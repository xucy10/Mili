...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    VanillaRecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
        ...
        return Stream.of(
            ...
            .map(pair -> {
                ...
                ResourceKey<Recipe<?>> resourceKey1 = ResourceKey.create(
                    Registries.RECIPE, Identifier.withDefaultNamespace(getItemName(item) + "_smithing_trim")
                );
