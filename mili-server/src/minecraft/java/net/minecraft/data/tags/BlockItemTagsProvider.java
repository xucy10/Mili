...
public abstract class BlockItemTagsProvider {
    protected void run() {
        ...
        this.tag(BlockTags.FLOWERS, ItemTags.FLOWERS).addTag(BlockTags.SMALL_FLOWERS).add(blocks1);
        ...
        this.tag(BlockTags.BEE_ATTRACTIVE, ItemTags.BEE_FOOD).add(blocks).add(blocks1);
    }
