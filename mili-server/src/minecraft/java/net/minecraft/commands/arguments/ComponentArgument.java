...
public class ComponentArgument extends ParserBasedArgument<Component> {
    ...
    public static Component getResolvedComponent(CommandContext<CommandSourceStack> context, String name, @Nullable Entity entity) throws CommandSyntaxException {
        return ComponentUtils.updateForEntity(context.getSource(), getRawComponent(context, name), entity, 0);
    }
    ...
    public static Component getResolvedComponent(CommandContext<CommandSourceStack> context, String name) throws CommandSyntaxException {
        return getResolvedComponent(context, name, context.getSource().getEntity());
    }
