...
public class AnvilMenu extends ItemCombinerMenu {
    ...
    public void createResult() {
        ...
        if (!item.isEmpty() && EnchantmentHelper.canStoreEnchantments(item)) {
            ...
            if (this.cost.get() >= this.maximumRepairCost && (!fun.bm.mili.config.modules.function.OldFeatureConfig.avoidAnvilTooExpensive || this.cost.get() == DEFAULT_DENIED_COST) && !this.player.hasInfiniteMaterials()) { // CraftBukkit // Mili - avoid anvil too expensive
                itemStack = ItemStack.EMPTY;
            }
