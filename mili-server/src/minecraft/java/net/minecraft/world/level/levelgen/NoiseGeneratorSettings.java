...
public record NoiseGeneratorSettings(
    ...
    private static NoiseGeneratorSettings overworld(BootstrapContext<?> context, boolean amplified, boolean large) {
        return new NoiseGeneratorSettings(
            NoiseSettings.OVERWORLD_NOISE_SETTINGS,
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.overworld(context.lookup(Registries.DENSITY_FUNCTION), context.lookup(Registries.NOISE), large, amplified),
