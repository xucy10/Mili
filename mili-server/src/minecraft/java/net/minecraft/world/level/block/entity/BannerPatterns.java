...
public class BannerPatterns {
    ...
    private static ResourceKey<BannerPattern> create(String name) {
        return ResourceKey.create(Registries.BANNER_PATTERN, Identifier.withDefaultNamespace(name));
    }
    ...
    public static void register(BootstrapContext<BannerPattern> context, ResourceKey<BannerPattern> resourceKey) {
        context.register(resourceKey, new BannerPattern(resourceKey.identifier(), "block.minecraft.banner." + resourceKey.identifier().toShortLanguageKey()));
    }
}
