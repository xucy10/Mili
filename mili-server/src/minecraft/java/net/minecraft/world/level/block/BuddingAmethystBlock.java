...
public class BuddingAmethystBlock extends AmethystBlock {
    ...
    // Mili start - budding amethyst can push by piston
    @Override
    @org.jetbrains.annotations.Nullable
    public net.minecraft.world.level.material.PushReaction getResetPushReaction() {
        return fun.bm.mili.config.modules.function.OldFeatureConfig.movableBuddingAmethyst ? net.minecraft.world.level.material.PushReaction.NORMAL : null;
    }
    // Mili end - budding amethyst can push by piston
}
