...
public class BuiltInLootTables {
    ...
    private static Map<DyeColor, ResourceKey<LootTable>> makeDyeKeyMap(String path) {
        return Util.makeEnumMap(DyeColor.class, color -> register(path + "/" + color.getName()));
    }

    private static ResourceKey<LootTable> register(String name) {
        return register(ResourceKey.create(Registries.LOOT_TABLE, Identifier.withDefaultNamespace(name)));
    }
