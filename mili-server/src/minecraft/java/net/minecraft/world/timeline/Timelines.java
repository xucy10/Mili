    ...
    static void bootstrap(BootstrapContext<Timeline> context) {
        ...
        context.register(
            ...
            Timeline.builder()
                ...
                .addTrack(EnvironmentAttributes.SUN_ANGLE, builder1 -> builder1.setEasing(easingType).addKeyframe(6000, 360.0F).addKeyframe(6000, 0.0F))
                .addTrack(EnvironmentAttributes.MOON_ANGLE, builder1 -> builder1.setEasing(easingType).addKeyframe(6000, 540.0F).addKeyframe(6000, 180.0F))
                .addTrack(EnvironmentAttributes.STAR_ANGLE, builder1 -> builder1.setEasing(easingType).addKeyframe(6000, 360.0F).addKeyframe(6000, 0.0F))
                .addModifierTrack(
                    EnvironmentAttributes.FIREFLY_BUSH_SOUNDS, BooleanModifier.OR, builder1 -> builder1.addKeyframe(12600, true).addKeyframe(23401, false)
                )
                .addModifierTrack(
                    EnvironmentAttributes.FOG_COLOR,
                    ColorModifier.MULTIPLY_RGB,
                    builder1 -> builder1.addKeyframe(133, -1)
                        .addKeyframe(11867, -1)
                ...
                .addModifierTrack(
                    ...
                    ColorModifier.MULTIPLY_RGB,
                    builder1 -> builder1.addKeyframe(133, -1).addKeyframe(11867, -1).addKeyframe(13670, -16777216).addKeyframe(22330, -16777216)
                )
                .addModifierTrack(
                    EnvironmentAttributes.SKY_LIGHT_COLOR,
                    ColorModifier.MULTIPLY_RGB,
                    builder1 -> builder1.addKeyframe(730, -1)
                        .addKeyframe(11270, -1)
                ...
                .addModifierTrack(
                    ...
                    builder1 -> builder1.addKeyframe(730, 1.0F).addKeyframe(11270, 1.0F).addKeyframe(13140, 0.24F).addKeyframe(22860, 0.24F)
                )
                .addModifierTrack(
                    EnvironmentAttributes.SKY_LIGHT_LEVEL,
                    FloatModifier.MULTIPLY,
                    builder1 -> builder1.addKeyframe(133, 1.0F).addKeyframe(11867, 1.0F).addKeyframe(13670, 0.26666668F).addKeyframe(22330, 0.26666668F)
                )
                .addTrack(
                    EnvironmentAttributes.SUNRISE_SUNSET_COLOR,
                    builder1 -> builder1.addKeyframe(71, 1609540403)
                ...
                .addModifierTrack(
                    ...
                    builder1 -> builder1.addKeyframe(92, 0.037F)
                ...
                .addTrack(EnvironmentAttributes.EYEBLOSSOM_OPEN, builder1 -> builder1.addKeyframe(12600, TriState.TRUE).addKeyframe(23401, TriState.FALSE))
                .addModifierTrack(
                    EnvironmentAttributes.CREAKING_ACTIVE, BooleanModifier.OR, builder1 -> builder1.addKeyframe(12600, true).addKeyframe(23401, false)
                )
                .addModifierTrack(
                    EnvironmentAttributes.TURTLE_EGG_HATCH_CHANCE,
                    FloatModifier.MAXIMUM,
                    builder1 -> builder1.setEasing(EasingType.CONSTANT).addKeyframe(21062, 1.0F).addKeyframe(21905, 0.002F)
                )
                .addModifierTrack(
                    EnvironmentAttributes.CAT_WAKING_UP_GIFT_CHANCE,
                    FloatModifier.MAXIMUM,
                    builder1 -> builder1.setEasing(EasingType.CONSTANT).addKeyframe(362, 0.0F).addKeyframe(23667, 0.7F)
                )
                .addModifierTrack(
                    EnvironmentAttributes.BEES_STAY_IN_HIVE, BooleanModifier.OR, builder1 -> builder1.addKeyframe(12542, true).addKeyframe(23460, false)
                )
                .addModifierTrack(
                    EnvironmentAttributes.MONSTERS_BURN, BooleanModifier.OR, builder1 -> builder1.addKeyframe(12542, false).addKeyframe(23460, true)
                )
                .build()
        );
        Timeline.Builder builder = Timeline.builder().setPeriodTicks(24000 * MoonPhase.COUNT).addTrack(EnvironmentAttributes.MOON_PHASE, builder1 -> {
            for (MoonPhase moonPhase : MoonPhase.values()) {
                builder1.addKeyframe(moonPhase.startTick(), moonPhase);
            }
        }).addModifierTrack(EnvironmentAttributes.SURFACE_SLIME_SPAWN_CHANCE, FloatModifier.MAXIMUM, builder1 -> {
            builder1.setEasing(EasingType.CONSTANT);

            for (MoonPhase moonPhase : MoonPhase.values()) {
                builder1.addKeyframe(moonPhase.startTick(), DimensionType.MOON_BRIGHTNESS_PER_PHASE[moonPhase.index()] * 0.5F);
            }
        });
        context.register(MOON, builder.build());
        int i3 = 2000;
        int i4 = 7000;
        context.register(
            VILLAGER_SCHEDULE,
            Timeline.builder()
                ...
                .addTrack(
                    ...
                    builder1 -> builder1.addKeyframe(10, Activity.IDLE)
        ...
        context.register(
            ...
            Timeline.builder()
                .addModifierTrack(
                    EnvironmentAttributes.CAN_PILLAGER_PATROL_SPAWN, BooleanModifier.AND, builder1 -> builder1.addKeyframe(0, false).addKeyframe(120000, true)
                )
                .build()
        );
    }
