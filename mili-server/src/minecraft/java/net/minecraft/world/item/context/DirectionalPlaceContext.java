...
public class DirectionalPlaceContext extends BlockPlaceContext {
    ...
    public DirectionalPlaceContext(Level level, BlockPos pos, Direction direction, ItemStack stack, Direction face) {
        super(level, null, InteractionHand.MAIN_HAND, stack, new BlockHitResult(Vec3.atBottomCenterOf(pos), face, pos, false));
