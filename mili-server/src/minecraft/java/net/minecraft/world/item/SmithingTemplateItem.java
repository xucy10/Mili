...
public class SmithingTemplateItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        tooltipAdder.accept(SMITHING_TEMPLATE_SUFFIX);
        tooltipAdder.accept(CommonComponents.EMPTY);
        tooltipAdder.accept(APPLIES_TO_TITLE);
        tooltipAdder.accept(CommonComponents.space().append(this.appliesTo));
        tooltipAdder.accept(INGREDIENTS_TITLE);
        tooltipAdder.accept(CommonComponents.space().append(this.ingredients));
    }
