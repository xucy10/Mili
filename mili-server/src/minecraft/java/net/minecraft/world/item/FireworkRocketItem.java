        ...
        if (player.isFallFlying()) {
            ...
            if (level instanceof ServerLevel serverLevel) {
                ...
                if (event.callEvent() && delayed.attemptSpawn()) {
                    ...
                    if (!fun.bm.mili.config.modules.function.OldFeatureConfig.keepLeashConnectWhenUseFirework && player.dropAllLeashConnections(null)) { // Leaves - Keep leash connection when using firework
