...
public class GossipContainer {
    ...
    public int getReputation(UUID identifier, Predicate<GossipType> gossip) {
        ...
        // Mili start - sharedVillagerDiscounts
        if (fun.bm.mili.config.modules.function.VillagerTradeConfig.sharedVillagerDiscounts && gossip.test(GossipType.MAJOR_POSITIVE)) {
            int otherRep = 0;
        ...
        // Mili end - sharedVillagerDiscounts
