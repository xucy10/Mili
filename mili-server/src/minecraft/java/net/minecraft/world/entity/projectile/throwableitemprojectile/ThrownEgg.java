...
public class ThrownEgg extends ThrowableItemProjectile {
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        // Mili start - make egg can knockback player
        if (fun.bm.mili.config.modules.function.OldFeatureConfig.snowballAndEggCanKnockback && result.getEntity() instanceof net.minecraft.server.level.ServerPlayer player) {
        ...
        // Mili end - make egg can knockback player
    }
