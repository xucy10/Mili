    ...
    static class BlazeAttackGoal extends Goal {
        ...
        public void tick() {
            ...
            if (target != null) {
                ...
                double d = this.blaze.distanceToSqr(target);
                if (d < 4.0) {
                    if (!hasLineOfSight) {
                        return;
                    }
                ...
                } else if (d < this.getFollowDistance() * this.getFollowDistance() && hasLineOfSight) {
                    double d1 = target.getX() - this.blaze.getX();
                    double d2 = target.getY(0.5) - this.blaze.getY(0.5);
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            double d4 = Math.sqrt(Math.sqrt(d)) * 0.5;
