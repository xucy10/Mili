        ...
        public void tick() {
            ...
            if (this.operation == MoveControl.Operation.MOVE_TO && !this.fish.getNavigation().isDone()) {
                ...
                if (d1 != 0.0) {
                    ...
                    this.fish.setDeltaMovement(this.fish.getDeltaMovement().add(0.0, this.fish.getSpeed() * (d1 / squareRoot) * 0.1, 0.0));
                }

                if (d != 0.0 || d2 != 0.0) {
                    float f1 = (float)(Mth.atan2(d2, d) * 180.0F / (float)Math.PI) - 90.0F;
