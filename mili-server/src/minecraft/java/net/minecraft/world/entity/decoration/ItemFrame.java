...
public class ItemFrame extends HangingEntity {
    ...
    public InteractionResult interact(Player player, InteractionHand hand) {
        ...
        if (this.fixed) {
            ...
            // Mili start - itemFrameContainerPassthrough
            if (fun.bm.mili.config.modules.function.OldFeatureConfig.containerPassthrough && !player.isShiftKeyDown() && (flag || !flag1)) {
            ...
            // Mili end - itemFrameContainerPassthrough
            if (!flag) {
